/**
 * State management functions extracted from forge-tools.cjs
 */

const fs = require('fs');
const path = require('path');

const { safeReadFile, loadConfig, output, error, findPhaseInternal, execGit,
        getArchivedPhaseDirs, searchPhaseInDir, getMilestoneInfo, normalizePhaseName,
        getForgeRoot } = require('./core.cjs');
