...
const { safeReadFile, loadConfig, output, error, normalizePhaseName, execGit,
        findPhaseInternal, getArchivedPhaseDirs, searchPhaseInDir, getRoadmapPhaseInternal,
        collectPhaseFiles, generateSlugInternal, pathExistsInternal, resolveModelInternal,
        getMilestoneInfo, getForgeRoot, getForgeGraphDir, graphDbExists, graphDbPath,
        getGraphStatus, getGraphContextForFiles, getGraphImpact, getLedger, ledgerLog,
...
function cmdInitExecutePhase(cwd, phase, includes, raw) {
  ...
  const result = {
    // Models
    executor_model: resolveModelInternal(cwd, 'forge-executor'),
    verifier_model: resolveModelInternal(cwd, 'forge-verifier'),
...
function cmdInitPlanPhase(cwd, phase, includes, raw) {
  ...
  const result = {
    ...
    checker_model: resolveModelInternal(cwd, 'forge-plan-checker'),
...
function cmdInitNewProject(cwd, raw) {
  ...
  const result = {
    // Models
    researcher_model: resolveModelInternal(cwd, 'forge-project-researcher'),
    synthesizer_model: resolveModelInternal(cwd, 'forge-research-synthesizer'),
    roadmapper_model: resolveModelInternal(cwd, 'forge-roadmapper'),
...
function cmdInitMapCodebase(cwd, raw) {
  ...
  const result = {
    // Models
    mapper_model: resolveModelInternal(cwd, 'forge-codebase-mapper'),
