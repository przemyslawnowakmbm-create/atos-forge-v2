...
```bash
INIT=$(node ~/.claude/atos-forge/bin/forge-tools.cjs init new-project)
```
...
```bash
mkdir -p .planning
node ~/.claude/atos-forge/bin/forge-tools.cjs commit "docs: initialize project" --files .planning/PROJECT.md
```
...
```
Task(prompt="First, read ~/.claude/agents/forge-project-researcher.md for your role and instructions.
...
Use template: ~/.claude/atos-forge/templates/research-project/STACK.md
</output>
...
Use template: ~/.claude/atos-forge/templates/research-project/FEATURES.md
</output>
...
Use template: ~/.claude/atos-forge/templates/research-project/ARCHITECTURE.md
</output>
...
Use template: ~/.claude/atos-forge/templates/research-project/PITFALLS.md
</output>
...
Use template: ~/.claude/atos-forge/templates/research-project/SUMMARY.md
...
```bash
node ~/.claude/atos-forge/bin/forge-tools.cjs commit "docs: define v1 requirements" --files .planning/REQUIREMENTS.md
```
...
```bash
node ~/.claude/atos-forge/bin/forge-tools.cjs commit "docs: create roadmap ([N] phases)" --files .planning/ROADMAP.md .planning/STATE.md .planning/REQUIREMENTS.md
```
