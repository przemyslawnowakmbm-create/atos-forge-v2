...
@~/.claude/atos-forge/references/model-profile-resolution.md
...
@~/.claude/atos-forge/references/phase-argument-parsing.md
...
node ~/.claude/atos-forge/bin/forge-tools.cjs state-snapshot | jq '.decisions'
```
